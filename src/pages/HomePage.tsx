        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-blue-100">
              Shop the latest trends in electronics, fashion, and home essentials with free delivery across India and 30-day returns.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Free delivery on all orders over ₹999. Fast and reliable delivery across India.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Carefully curated products from trusted brands with guaranteed quality.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Your data is protected with industry-leading security and encryption.</p>
            </div>
          </div>
        </div>
      </section>
